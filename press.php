				...
				<div class="media-hovers-outer">
					...
					<?php
						...
						if ( $pPost_media['hover_link'] === 'permalink' ) {
							...
							echo '<a target="_blank" href="'. esc_url($rf_link_url) .'" class="media-hover-link"></a>';
...
<?php else: ?>
	<div class="inner-content">
		<h3><?php esc_html_e( 'No Press Items found!', 'hyperx' ); ?></h3>
	</div>
<?php endif; ?>
...
<style>
.category-press .post-media {
/*    height: 18em;*/
}
</style>

<script>
//var divWidth = $('.post-media').width(); 
//
//$(window).resize(function(){
//    $('.post-media').height(divWidth);
//});
